                   ...
                   {selectedEvent ? selectedEvent.key == "tasks" ? (
                     ...
                     <div>
                         ...
                         <input
                           ...
                           onChange={(e) => setCreatedEvent({ ...createdEvent, startTime: e.target.value })}
                     ...
                     onClick={async () => {
                       if (selectedEvent) {
                        ...
                        if(createdEvent.startTime) {
                         startDateTime = new Date(`${createdEvent.start}T${createdEvent.startTime}`);                              
                       }
                       else {
                         startDateTime = new Date(`${createdEvent.start}`);                              
                
                       }
                       const created_Event = {...createdEvent, startDateTime: startDateTime};
                         setCreatedEvent({...createdEvent, startDateTime: startDateTime});
